...
first. We report the full methodology, including a page-cache measurement defect that invalidated
an earlier round of results, and discuss what this suite's data does and does not establish about
...
anywhere in this codebase. \texttt{sq\_thread\_idle} is 1000\,ms everywhere in this study; we did
not sweep it. Neither the SQPOLL kernel thread nor any application thread was pinned to a
...
with hardware performance counters, and the fixed \texttt{sq\_thread\_idle} and completion-side
backoff constants (Section~IV-D) were not swept. Finally, this study compares only SQPOLL, plain
...
tail-latency growth remains open, and this study does not compare against
